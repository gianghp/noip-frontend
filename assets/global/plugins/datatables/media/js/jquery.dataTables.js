		...
		if ( aiDisplay.length !== 0 )
		{
			...
			var iEnd = bServerSide ? oSettings.aoData.length : iDisplayEnd;
                        ...
                        head.each(function(){
                            ...
                            if (cl.indexOf('hidden-320') >=0 )
                                cols[ii] = 'hidden-320';
                            else if (cl.indexOf('hidden-400') >=0 )
                                cols[ii] = 'hidden-400';
                            else if (cl.indexOf('hidden-480') >=0 )
                                cols[ii] = 'hidden-480';
                            else if (cl.indexOf('hidden-580') >=0 )
                                cols[ii] = 'hidden-580';
                            else if (cl.indexOf('hidden-680') >=0 )
                                cols[ii] = 'hidden-680';
                            else if (cl.indexOf('hidden-780') >=0 )
                                cols[ii] = 'hidden-780';
                            else if (cl.indexOf('hidden-880') >=0 )
                                cols[ii] = 'hidden-880';
                            else if (cl.indexOf('hidden-980') >=0 )
                                cols[ii] = 'hidden-980';
                            else if (cl.indexOf('hidden-1024') >=0 )
                                cols[ii] = 'hidden-1024';
                            else cols[ii] = "";
                            ++ii;
                        });
			...
			for ( var j=iStart ; j<iEnd ; j++ )
			{
				...
				var nRow = aoData.nTr;
                                ...
                                $(nRow).find('td').each(function(){
                                    var me = $(this);
                                    if (ii < cols.length && cols[ii].length > 0)
                                          me.addClass(cols[ii]);
                                    ++ii;
                                });
