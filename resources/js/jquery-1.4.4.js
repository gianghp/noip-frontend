...
$.fn.showTitle = function(title, w, s) {
	...
	if (dv.length == 0)
	{
		dv = $('<div id="dvShowTitle" class="dvShowTitle ui-corner-all"><div style="float:left;" id="mess"></div><div id="close" style="float:right;" title="Đóng" class="ui-icon ui-icon-close"></div></div>');
		$('body').append(dv);
	}
...
jQuery.loadcomments = function()
{
    ...
    aComment.each(function(){
        var default_status_text = "Bạn đang nghĩ gì ...";
        var me = $(this);
        $.ajax({
        ...
        error: function(jqXHR, exception) {               
            ...
            if(this.type.toLowerCase() == "post")
            {
                if (this.errorText) alert(this.errorText);
                    ...
                    //alert('Có lỗi: Không kết nối được Internet.');
                } else if (jqXHR.status == 404) {
                    //alert('Có lỗi: Requested page not found. [404]');
                } else if (jqXHR.status == 500) {
                    alert('Có lỗi: Internal Server Error [500].');
                } else if (exception === 'parsererror') {
                    alert('Có lỗi: Requested JSON parse failed.');
                } else if (exception === 'timeout') {
                    alert('Có lỗi: Time out error.');
                } else if (exception === 'abort') {
                    alert('Có lỗi: Ajax request aborted.');
                } else {
                    alert('Có lỗi: Uncaught Error.\n' + jqXHR.responseText);
                }  
            }
        }
    });
