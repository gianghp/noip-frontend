var GroupLeader = function () {
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ajax: {
                    url: "/admin/group_leader/get.do?group_id=" + Metronic.getURLParameter("group_id")
                },
                columnDefs: [
                {
                    orderable: false,
    ...
    return {
        init: function () {
            ...
            $('#form-add-user').submit(function(){
                $.ajax({
                    url : "/admin/group_leader/save.do",
            ...
            $('#importFromExcel').click(function(){
                Metronic.showImportExcel(function(aFiles){
                    $.ajax({
                        url : "/admin/group_leader/import.do",
                    ...
                    bootbox.dialog({
                        ...
                        buttons: {
                            success: {
                                ...
                                callback: function () {
                                    $.ajax({
                                        url : "/admin/group_leader/delete.do",
