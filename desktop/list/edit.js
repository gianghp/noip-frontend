        ...
        var form = new Ext.FormPanel({
            ...
            items: [
                ...
                },
                {
                    xtype: 'checkboxfield',
                    margin: '0 0 5 0',
                    fieldLabel: 'Loại danh mục',
                    boxLabel  : 'Bảng riêng',
                    name      : 'listtype',
                    inputValue: true,
                    checked   : args.data? args.data.listtype : true
                }
            ]
        });
                    ...
                    items: [
                        {
                            ...
                            handler: function() {
                                ...
                                if (frm.isValid()){
                                    $.ajax({
                                        url: args.data ? Services.list + "/" + args.data.id + "/update" : Services.list + "/create",
