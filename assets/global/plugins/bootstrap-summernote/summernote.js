  ...
  var Dialog = function () {
    ...
    this.showImageDialog = function ($editable, $dialog) {
      return $.Deferred(function (deferred) {
        ...
        $imageDialog.find('.modal-footer').html('<a href="javascript:;" class="btn note-image-btn btn-success">Insert image</a>');
        $imageDialog.find('.modal-header').html('<button type="button" class="close" aria-hidden="true" tabindex="-1">×</button><h4>Insert image</h4>');
        var $imageInput = $imageDialog.find('.note-image-input'),
            $imageUrl = $imageDialog.find('.note-image-url'),
            $imageBtn = $imageDialog.find('.note-image-btn'),
            $closeBtn = $imageDialog.find('.close');
