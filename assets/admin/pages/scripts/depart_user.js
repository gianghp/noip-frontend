var DepartLeader = function () {
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ajax: {
                    url: "/admin/depart_user/get.do?depart_id=" + Metronic.getURLParameter("depart_id")
                },
                columnDefs: [
                {
                    orderable: false,
        ...
        init: function () {
            ...
            $('#importFromExcel').click(function(){
                Metronic.showImportExcel(function(aFiles){
                    $.ajax({
                        url : "/admin/depart_user/import.do",
                    ...
                    bootbox.dialog({
                        ...
                        buttons: {
                            success: {
                                ...
                                callback: function () {
                                    $.ajax({
                                        url : "/admin/depart_user/delete.do",
